...
--
-- Host: localhost:3307
-- Generation Time: May 19, 2019 at 04:01 AM
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `GetItemsByType` (IN `_Type` VARCHAR(45), IN `_Library` VARCHAR(45), IN `_IsAdmin` INT)  NO SQL
BEGIN
...
SELECT MAX(CAST(REGEXP_SUBSTR(itemID, '[0-9].*') AS INTEGER))
FROM item
...
(8, 'KSCTestItem3', 11, 1, '2019-05-08', '2019-05-08', 1),
...
(20, 'KSCTestItem5', 20, 0, '2019-05-20', '2019-06-03', 0),
(21, 'KSCTestItem43', 20, 0, '2019-05-28', '2019-06-11', 1),
(22, 'KSCTestItem6', 21, 0, '2019-05-20', '2019-06-03', 0),
...
(27, 'KSCTestItem42', 26, 0, '2019-08-05', '2019-08-19', 1),
...
--
ALTER TABLE `reservation`
  MODIFY `reserveid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;
